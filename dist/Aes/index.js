...
class Aes extends Block_1.Block {
    /**
     *
     * @param blockSize
     */
     ...
     * @returns
     */
    e(plaintext, password, nBits) {
        plaintext = utf8_1.default.encode(plaintext);
        password = utf8_1.default.encode(password);
        var nBytes = nBits / 8;
    ...
    d(ciphertext, password, nBits) {
        ...
        for (var b = 0; b < nBlocks; b++)
            ct[b] = ciphertext.slice(8 + b * this.blockSize, 8 + b * this.blockSize + this.blockSize);
        ciphertext = ct;
        ...
        try {
            plaintext = utf8_1.default.decode(plaintext);
            if (!plaintext)
                throw Error();
        }
        catch (e) {

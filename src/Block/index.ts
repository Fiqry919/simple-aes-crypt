...
export class Block {
     ...
     * 
     */
    private static readonly sBox: E = [
     ...
     * 
     */
    private static readonly rCon: E = [
        [0x00, 0x00, 0x00, 0x00],
        [0x01, 0x00, 0x00, 0x00],
        [0x02, 0x00, 0x00, 0x00],
        [0x04, 0x00, 0x00, 0x00],
     ...
     * @returns 
     */
    private static addRoundKey(state: E, w: E, rnd: E, Nb: E): E {
        for (var r = 0; r < 4; r++) {
     ...
     * @returns 
     */
    private static mixColumns(s: E, Nb: E): E {
        for (var c = 0; c < 4; c++) {
            var a = new Array(4);
            var b = new Array(4);
            for (var i = 0; i < 4; i++) {
     ...
     * @returns 
     */
    private static shiftRows(s: E, Nb: E): E {
        var t = new Array(4);
        for (var r = 1; r < 4; r++) {
     ...
     * @returns 
     */
    private static subBytes(s: E, Nb: E): E {
        for (var r = 0; r < 4; r++) {
